<template>
    <div style="position: relative;">
        <Carousel :items="items" :timeRunning="3000" :timeAutoNext="7000" />
    </div>
    <Cards />
    <WrapperContainer>
...
onMounted(() => {
    ...
    items.value = sliderStore.items
})
const dummyImages = ['https://s3-us-west-2.amazonaws.com/s.cdpn.io/557257/1.png',
